...
<ModuleFile xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" >
	<UiMod name="Moth" version="See Description" date="2009-05-03T21:39:12Z" >
		<Author name="tronned" email="tronned@verizon.net" />
		<Description text="Mouse Over Target Hover ~><<br><br>Version: 1.21 Revision: 48 Date: 20090503213912" />
        <VersionSettings gameVersion="1.4.0" windowsVersion="1.0" savedVariablesVersion="1.0" />
		<Dependencies>
			<Dependency name="EA_MouseOverTargetWindow" /> <!-- Coutersy of Aiiane and beatrix_kiddo <3 -->
